...
public class DLeftCuckooHashtableTest {
  @Test
  void test() {
    DLeftCuckooHashtable classUnderTest = new DLeftCuckooHashtable(1000, 3, 2);
    ...
    File outFile = new File("src/test/resources/dleft-cuckoo-out.txt");
